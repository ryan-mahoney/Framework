...
You can read more about this in the *Collection* component, see: :ref:`_collections`.  FMF comes with many pre-defined collections for popular data types like blogs, pages, videos, photo galleries, etc.
